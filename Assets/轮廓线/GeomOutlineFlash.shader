Shader "Hidden/GeomOutlineFlash"
{
    Properties
    {
        _OutlineColor("Outline Color", Color) = (1, 0, 0, 1)
        _Thickness("Thickness", float) = 1
		_Flash("Flash",Range(0,10))=  2
    }
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            CGPROGRAM
                ...
                {
                    //_OutlineColor.a = 1;
					float v = abs(sin(_Time.y*_Flash));
					float val = smoothstep(0.0, 1.0, v);
					float4 col = float4(_OutlineColor.x, _OutlineColor.y, _OutlineColor.z, val);
                    return col;
                }
            ENDCG
        }
